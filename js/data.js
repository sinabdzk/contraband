...
export const CONFIG = {
  ...
  XP_GROWTH_FACTOR: 1.45,
  HEAT_DECAY_PER_TICK: 0.12,
  HEAT_RAID_THRESHOLD: 80,
  HEAT_RAID_CHANCE: 0.03,
  MAX_HEAT: 100,
  BASE_LAUNDER_EFFICIENCY: 0.65,
  RECRUIT_BASE_COST: 800,
  RECRUIT_COST_GROWTH: 1.35,
  MAX_CREW_BASE: 4,
  STARTING_RESOURCES: {
    dirtyMoney: 300,
    cleanMoney: 0,
...
export const OPERATIONS = [
  {
    id: 'street_dealing',
    name: 'Street Dealing',
    desc: 'Push small bags on the corner. You need at least one crew member working the handoffs.',
    category: 'Drugs',
    unlockCost: 0,
    levelReq: 1,
    minCrew: 1,
  ...
  },
  {
    id: 'tobacco_run',
    name: 'Tobacco Run',
    desc: 'Smuggle bootleg cigarettes across county lines. A driver and some nerve — the Shelby way.',
    category: 'Contraband',
    unlockCost: 600,
    levelReq: 2,
    minCrew: 1,
    cost: { dirtyMoney: 80, supplies: 1 },
    duration: 10,
    reward: { dirtyMoney: 250, supplies: 2 },
    heatGain: 1,
    xp: 12,
    autoCapable: true,
    autoReq: 6,
  },
  {
    ...
    desc: 'Organize skilled pickpockets in tourist areas. Nimble fingers, quick cash.',
    category: 'Theft',
    unlockCost: 1200,
    levelReq: 3,
    minCrew: 1,
    cost: { dirtyMoney: 80 },
    duration: 12,
    reward: { dirtyMoney: 300, supplies: 1 },
    heatGain: 2,
    xp: 14,
    autoCapable: true,
    autoReq: 7,
  ...
  {
    id: 'bootleg_distillery',
    name: 'Bootleg Distillery',
    desc: 'Cook moonshine in a hidden still and sell to speakeasies. By order of the Peaky Blinders.',
    category: 'Contraband',
    unlockCost: 3000,
    levelReq: 4,
    minCrew: 2,
    miniGame: 'cook',
    cost: { dirtyMoney: 200, supplies: 4 },
    duration: 18,
    reward: { dirtyMoney: 800, supplies: 1 },
    heatGain: 3,
    xp: 25,
    autoCapable: true,
    autoReq: 8,
  },
  {
    id: 'burglary',
    name: 'Burglary Crew',
    desc: 'Hit houses while owners sleep. Need a lookout and someone inside — minimum two.',
    category: 'Theft',
    unlockCost: 4000,
    levelReq: 5,
    minCrew: 2,
    cost: { dirtyMoney: 300 },
    duration: 20,
    reward: { dirtyMoney: 1200, supplies: 3 },
    heatGain: 5,
    xp: 30,
    autoCapable: true,
    autoReq: 9,
  },
  {
    ...
    desc: 'Charge local businesses for "insurance". They pay, or things happen. Classic Shelby business.',
    category: 'Extortion',
    unlockCost: 8000,
    levelReq: 6,
    minCrew: 2,
    cost: { dirtyMoney: 150, influence: 3 },
    duration: 25,
    reward: { dirtyMoney: 1800, influence: 2 },
    heatGain: 4,
    xp: 40,
    autoCapable: true,
    autoReq: 10,
  },
  {
    id: 'drug_lab',
    name: 'The Cook',
    desc: 'Set up a mobile lab and cook product. Quality matters — 99.1% purity or nothing. Heisenberg would approve.',
    category: 'Drugs',
    unlockCost: 22000,
    levelReq: 8,
    minCrew: 2,
    miniGame: 'cook',
    cost: { dirtyMoney: 800, supplies: 10 },
    duration: 35,
    reward: { dirtyMoney: 5500, supplies: 3 },
    heatGain: 8,
    xp: 65,
    autoCapable: true,
    autoReq: 12,
  ...
  {
    id: 'whiskey_shipment',
    name: 'Whiskey Shipment',
    desc: 'Arrange a border-crossing for crates of contraband spirits. Moving goods by the canal, Shelby style.',
    category: 'Contraband',
    unlockCost: 35000,
    levelReq: 9,
    minCrew: 2,
    cost: { dirtyMoney: 1500, supplies: 5 },
    duration: 30,
    reward: { dirtyMoney: 6000, influence: 2 },
    heatGain: 5,
    xp: 70,
    autoCapable: true,
    autoReq: 13,
  },
  {
    id: 'chop_shop',
    name: 'Chop Shop',
    desc: 'Steal cars, strip them, sell the parts. Full crew needed — driver, muscle, mechanic.',
    category: 'Theft',
    unlockCost: 50000,
    levelReq: 10,
    minCrew: 3,
    cost: { dirtyMoney: 1200 },
    duration: 40,
    reward: { dirtyMoney: 9000, supplies: 5 },
    heatGain: 7,
    xp: 90,
    autoCapable: true,
    autoReq: 14,
  },
  {
    id: 'counterfeiting',
    name: 'Counterfeiting',
    desc: 'Print fake bills. Slow but massive volume. "I am the one who prints."',
    category: 'Fraud',
    unlockCost: 100000,
    levelReq: 13,
    minCrew: 2,
    cost: { dirtyMoney: 4000, supplies: 12 },
    duration: 50,
    reward: { dirtyMoney: 22000 },
    heatGain: 10,
    xp: 130,
    autoCapable: true,
    autoReq: 17,
  },
  {
    ...
    desc: 'Move military-grade weapons across borders. One mistake and it\'s over. High risk, high reward.',
    category: 'Trafficking',
    unlockCost: 300000,
    levelReq: 16,
    minCrew: 3,
    cost: { dirtyMoney: 15000, supplies: 18 },
    duration: 65,
    reward: { dirtyMoney: 65000, influence: 6 },
    heatGain: 20,
    xp: 220,
    autoCapable: true,
    autoReq: 20,
  },
  {
    id: 'cybercrime',
    name: 'Cyber Heist',
    desc: 'Hack bank servers and siphon funds. Clean, quiet — Saul Goodman approved money routing.',
    category: 'Cyber',
    unlockCost: 700000,
    levelReq: 19,
    minCrew: 2,
    cost: { dirtyMoney: 10000 },
    duration: 35,
    reward: { dirtyMoney: 48000, cleanMoney: 6000 },
    heatGain: 4,
    xp: 200,
    autoCapable: true,
    autoReq: 23,
  },
  {
    id: 'casino_heist',
    name: 'The Big Score',
    desc: 'Plan and execute a daring casino robbery. One shot. One crew. Millions on the line.',
    category: 'Heist',
    unlockCost: 2000000,
    levelReq: 23,
    minCrew: 4,
    miniGame: 'heist',
    cost: { dirtyMoney: 60000, supplies: 25, influence: 12 },
    duration: 120,
    reward: { dirtyMoney: 400000, influence: 18 },
    heatGain: 28,
    xp: 550,
    autoCapable: false,
  },
  {
    id: 'import_export',
    name: 'The Shipment',
    desc: 'International smuggling network. Container ships, ghost manifests, corrupt port officials.',
    category: 'Trafficking',
    unlockCost: 5000000,
    levelReq: 26,
    minCrew: 4,
    cost: { dirtyMoney: 100000, supplies: 35, influence: 18 },
    duration: 150,
    reward: { dirtyMoney: 550000, supplies: 25, influence: 12 },
    heatGain: 22,
    xp: 900,
    autoCapable: true,
    autoReq: 28,
  },
  {
    id: 'financial_fraud',
    name: 'The Ozark Play',
    desc: 'Shell companies, insider trading, Ponzi schemes. Money flows like water. Full Saul Goodman.',
    category: 'Fraud',
    unlockCost: 15000000,
    levelReq: 30,
    minCrew: 3,
    cost: { cleanMoney: 250000, influence: 35 },
    duration: 220,
    reward: { dirtyMoney: 1800000, cleanMoney: 600000, influence: 30 },
    heatGain: 16,
    xp: 1800,
    autoCapable: true,
    autoReq: 32,
...
// ============================================================
// SUPPLY MARKET — Source your product
// ============================================================
export const SUPPLY_MARKET = [
  { id: 'street_pickup', name: 'Street Pickup', desc: 'Buy a small batch from a local dealer. Quick and easy.', cost: { dirtyMoney: 200 }, yield: 5, heatGain: 1, levelReq: 1 },
  { id: 'dock_contact', name: 'Dock Contact', desc: 'Crate from the harbor. Reliable, no questions asked.', cost: { dirtyMoney: 800 }, yield: 15, heatGain: 0, levelReq: 4 },
  { id: 'cartel_deal', name: 'Cartel Deal', desc: 'Bulk product from the cartel. Negotiate carefully.', cost: { dirtyMoney: 3000, influence: 2 }, yield: 40, heatGain: 2, levelReq: 8 },
  { id: 'factory_raid', name: 'Factory Raid', desc: 'Hit a pharmaceutical factory. Massive haul, massive heat.', cost: { dirtyMoney: 5000 }, yield: 60, heatGain: 12, levelReq: 12 },
  { id: 'international_source', name: 'International Source', desc: 'Container ship, ghost manifest. Industrial scale.', cost: { dirtyMoney: 15000, influence: 5 }, yield: 150, heatGain: 3, levelReq: 18 },
];

// ============================================================
// MINI-GAMES — Interactive skill checks
// ============================================================
export const MINI_GAMES = {
  cook: {
    title: 'COOK THE PRODUCT',
    desc: 'Stop the needle in the GREEN zone for maximum purity.',
    icon: 'heat',
    speed: 2.0,
    zones: [
      { start: 0, end: 15, label: 'Burnt', color: '#ef4444', multiplier: 0.3, heat: 5 },
      { start: 15, end: 35, label: 'Impure', color: '#f59e0b', multiplier: 0.7, heat: 2 },
      { start: 35, end: 65, label: 'Pure', color: '#22c55e', multiplier: 1.5, heat: 0 },
      { start: 65, end: 85, label: 'Impure', color: '#f59e0b', multiplier: 0.7, heat: 2 },
      { start: 85, end: 100, label: 'Burnt', color: '#ef4444', multiplier: 0.3, heat: 5 },
    ],
  },
  heist: {
    title: 'CRACK THE VAULT',
    desc: 'Stop the needle in the GREEN zone to breach security.',
    icon: 'lock',
    speed: 3.0,
    zones: [
      { start: 0, end: 20, label: 'ALARM', color: '#ef4444', multiplier: 0.4, heat: 10 },
      { start: 20, end: 40, label: 'Close', color: '#f59e0b', multiplier: 0.8, heat: 3 },
      { start: 40, end: 60, label: 'Cracked', color: '#22c55e', multiplier: 1.5, heat: 0 },
      { start: 60, end: 80, label: 'Close', color: '#f59e0b', multiplier: 0.8, heat: 3 },
      { start: 80, end: 100, label: 'ALARM', color: '#ef4444', multiplier: 0.4, heat: 10 },
    ],
  },
};

// ============================================================
// TERRITORY MAP POSITIONS (for visual map layout)
// ============================================================
export const TERRITORY_MAP = {
  slums:              { col: '1 / 5',  row: '3 / 4' },
  docklands:          { col: '5 / 9',  row: '3 / 4' },
  chinatown:          { col: '9 / 13', row: '3 / 4' },
  red_light:          { col: '1 / 5',  row: '2 / 3' },
  industrial:         { col: '5 / 9',  row: '2 / 3' },
  downtown:           { col: '9 / 13', row: '2 / 3' },
  tech_district:      { col: '1 / 7',  row: '1 / 2' },
  financial_district: { col: '7 / 13', row: '1 / 2' },
  uptown:             { col: '3 / 8',  row: '4 / 5' },
  city_hall:          { col: '8 / 13', row: '4 / 5' },
};
